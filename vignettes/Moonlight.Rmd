...
Samples 100 mutation to reduce size of file.  
...
dataMAF <- dataMAF %>% sample_n(size = 100, replace = FALSE)
```
...
In the following plot all the oncogenic mediators and their mutations are shown.

```{r, eval = TRUE, echo = TRUE, results='hide', warning = FALSE, message = FALSE}
data()
data()
plotDMA(DEG_Mutations_Annotions, Oncogenic_mediators_mutation_summary, 
        type = "complete",
