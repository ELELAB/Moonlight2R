...
loadMAVISp is used to load the files in the MAVISp database. The user will 
need to decide on whether they want to import the simple or ensemble mode and
...
The TFinfluence function can be used as after the PRA function, to identify
if there are mutations in the transcription factors to the DEGs. The function 
uses data from TRRUST to couple the DEGs with their transcription factor (TF). 
The mutations in the TFs come from the MAF file, and the effect of the mutation
