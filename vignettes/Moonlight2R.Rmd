...
of possible driver genes, and if any mutation available in a cancer mutation dataset
is able to destabilize them and therefore likely affect transcription.
...
on the transcription of genes of interest ii) identify mutations of interest on them from
MAF files iii) use MAVISp data to assess the affect of such mutations, whether they
